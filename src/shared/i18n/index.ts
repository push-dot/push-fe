...
const dict = {
  ko: {
    ...
    'composer.drop': '파일을 놓으면 업로드돼요',
    'composer.removeFile': '파일 제거',
    'infer.model': '모델',
    ...
    'settings.byokModel': 'BYOK 모델',
    'settings.byokProvider': 'BYOK 프로바이더',
    'menu.rename': '이름 바꾸기',
    'menu.pin': '고정',
    'menu.unpin': '고정 해제',
    'menu.delete': '삭제',
    'common.back': '뒤로',
    'plan.title': '플랜 업그레이드',
    'plan.subtitle': '필요한 플랜을 선택하세요',
    'plan.current': '현재 플랜',
    'plan.downgrade': '다운그레이드',
    'plan.perMonth': '/월',
    'plan.proName': 'Pro',
    'plan.ultraName': 'Ultra',
    'plan.proPrice': '$30',
    'plan.ultraPrice': '$100',
    'plan.proFeat1': '모든 관리형 모델',
    'plan.proFeat2': '웹 검색',
    'plan.proFeat3': '무제한 채팅',
    'plan.ultraFeat1': 'Pro의 모든 기능',
    'plan.ultraFeat2': '맞춤 이력서 생성',
    'plan.ultraFeat3': '우선 지원',
    'plan.freeFeat1': '기본 채팅',
    'plan.freeFeat2': '관리형 모델 일부',
  },
  en: {
    ...
    'home.titleAlt': 'What shall we push today?',
    ...
    'composer.drop': 'Drop files to upload',
    ...
    'settings.byokModel': 'BYOK model',
    'settings.byokProvider': 'BYOK provider',
    'menu.rename': 'Rename',
    'menu.pin': 'Pin',
    'menu.unpin': 'Unpin',
    'menu.delete': 'Delete',
    'common.back': 'Back',
    'plan.title': 'Upgrade plan',
    'plan.subtitle': 'Choose the plan that fits you',
    ...
    'plan.proPrice': '$30',
    'plan.ultraPrice': '$100',
    'plan.proFeat1': 'All managed models',
    'plan.proFeat2': 'Web search',
    'plan.proFeat3': 'Unlimited chats',
    'plan.ultraFeat1': 'Everything in Pro',
    'plan.ultraFeat2': 'Tailored resume generation',
    'plan.ultraFeat3': 'Priority support',
    'plan.freeFeat1': 'Basic chat',
    'plan.freeFeat2': 'Some managed models',
  },
} as const
